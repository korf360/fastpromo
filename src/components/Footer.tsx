        ...
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex flex-col gap-6 sm:items-end">
            ...
            >
              <a
                href="/terms"
                className="text-white/50 transition-all duration-300 hover:text-[#FFD700] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FFD700]"
              >
                Terms of Service
              </a>
              <a
            ...
            <p className="text-xs text-white/35 sm:text-right">
              GDPR Data Compliance — we process only what is required to deliver
              your order.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-xl border border-[#5865F2]/40 bg-[#5865F2]/15 px-4 py-3 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#5865F2]/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FFD700]"
            >
              <DiscordIcon className="h-5 w-5" />
              Join for 24/7 Live Support
            </a>
          </div>
        </div>
      </div>
