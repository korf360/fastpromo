-- Finance ledger for payments (income) and business expenses.
-- Apply on Supabase Postgres via: npx prisma migrate deploy
-- (or run this SQL in the Supabase SQL editor if migrating manually)
